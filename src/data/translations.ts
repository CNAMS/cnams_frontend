...
export const translations = {
  ...
  reevaluateQueued: {
    ...
    hi: 'पुनर्मूल्यांकन कतार में। अगली सिंक पर रिकॉर्ड का पुनर्वर्गीकरण होगा।',
  },
  ...
  userApprovedToast: { en: 'account approved', hi: 'खाता स्वीकृत' },
  userRejectedToast: { en: 'request rejected', hi: 'अनुरोध अस्वीकृत' },
